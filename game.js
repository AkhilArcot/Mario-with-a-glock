...
scene("game", ({ level, score }) => {
  ...
  const maps = [
    ...
    [
      '_       $$$             _                        ______               _',
      '_   _______________    _     E              _________^^^^            _',
      '_                       ________      ___                           _',
      '_         h    _______               $$$$        ___        P       _',
      '___________^^^______^^^^^^___________$$$$_______________________  ___',
      '_                                    $$$$                         $$$',
      '_        E     E     E    E    E                                  $$$',
    ...
    [
      '_       h          _   P         _                                ___',
      '_   _______     ________    ________^^^^^^_______     ___         $$$',
      '_                                                            p     __',
      '_                $$$$$$         $$$$$$        $$$$$$              ___',
      '_        ____________________________________________^^^__________$$$',
      '_         $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$',
      '_                                                                    _',
    ...
    [
      '_   p                    h         E                                _',
      '_   ____^^^____     _________^^__________^^__________^^_________   _',
      '_                                                                    _',
      '_     $$$$$$$$$$   $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$     _',
      '_         E       E       E       E       E       E       E         _',
    ...
    [
      '_    P       $$$$     ________________     $$$$       P            _',
      '_          ____^^^____            ____^^^_____     _________^^^    _',
      '_     h                  E     E             E        E     E      _',
    ...
    [
      '_    p                                                           _',
      '_      ________^^^^^________    ________^^^^^_________   h       _',
      '_    E    E    E    E    E    E    E    E    E    E    E         _',
